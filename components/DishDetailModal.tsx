...
export const DishDetailModal: React.FC<{ dish: any; onClose: () => void; onIngredientClick: (ing: any) => void; onSpicyClick: () => void; }> = ({ dish, onClose, onIngredientClick, onSpicyClick }) => {
  ...
  return (
    <div className="fixed inset-0 z-[120] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="bg-[#fcfbf9] w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-[3rem] shadow-2xl relative p-8 md:p-12">
        ...
        <header className="mb-10">
          <h2 className="chinese-font text-6xl font-bold text-slate-900 mb-4">{dish.name_cn}</h2>
