    ...
    >
      ...
      <div className="p-5 md:p-7 flex flex-col justify-between h-full w-full">
        <div>
          ...
          <h4 className="text-sm font-bold text-slate-400 mb-4 tracking-tight leading-tight">{nameEN}</h4>
            ...
            {isAnalyzing ? (
              ...
              <div className="flex flex-wrap gap-1.5 animate-in fade-in duration-700">
                {ingredients.slice(0, 3).map((ing: any, i: number) => (
                  <span key={i} className="text-[9px] font-bold bg-slate-50 text-slate-500 px-2 py-1 rounded-md border border-slate-100 group-hover:border-rose-100 transition-colors">
          ...
          <p className="text-slate-400 text-[11px] line-clamp-2 mb-4 leading-relaxed font-medium italic">
            {description || "Discovering the flavors of this dish..."}
          </p>
        </div>
