  ...
  return (
    <section className="bg-white rounded-[2.5rem] p-12 md:p-20 shadow-xl border border-slate-50 text-center relative overflow-hidden group">
      ...
      <div className="relative z-10 space-y-8">
        <div className="inline-block px-4 py-1 border border-slate-100 rounded-full text-[10px] font-semibold uppercase tracking-[0.3em] text-slate-400">
          Our Mission
        </div>
        
        <h3 className="text-4xl md:text-5xl font-semibold text-slate-900 tracking-tight leading-none">
        ...
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          <p className="text-slate-500 text-sm font-medium uppercase tracking-wider leading-relaxed">
        ...
        <div className="flex justify-center items-center gap-10 pt-6">
           <div className="text-center">
             <div className="text-2xl font-semibold text-slate-900">12k+</div>
             <div className="text-[10px] font-medium text-slate-400 uppercase tracking-widest">Dishes Decoded</div>
           </div>
           <div className="h-10 w-px bg-slate-100"></div>
           <div className="text-center">
             <div className="text-2xl font-semibold text-slate-900">50+</div>
             <div className="text-[10px] font-medium text-slate-400 uppercase tracking-widest">Regions Covered</div>
           </div>
        </div>
      </div>
      
      {/* Decorative background element */}
      <div className="absolute -bottom-10 -right-10 text-9xl font-bold text-slate-50 chinese-font select-none pointer-events-none group-hover:text-rose-50 transition-colors">
        食
      </div>
    </section>
  );
