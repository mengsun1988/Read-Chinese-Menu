    ...
    <div className={`fixed inset-0 z-[100] transition-colors duration-500 flex flex-col items-center justify-between p-8 text-white text-center animate-in fade-in zoom-in duration-300 ${
      ...
      <div className="w-full flex justify-between items-center">
        ...
        >
          ...
          <span className="font-black text-sm uppercase tracking-widest">Speak / 语音</span>
        </button>
      ...
      <div className="space-y-12 max-w-2xl w-full flex-1 flex flex-col justify-center">
        {response ? (
          <div className="animate-in zoom-in duration-300 text-center space-y-4">
            <h2 className="text-9xl font-black">{response === 'YES' ? 'YES' : 'NO'}</h2>
            <h3 className="text-6xl font-black chinese-font">{response === 'YES' ? '是 / 有' : '不 / 没有'}</h3>
            <button 
              onClick={() => setResponse(null)}
              className="mt-8 text-white/60 font-bold underline"
            >
              Reset / 重置
            </button>
          </div>
            ...
            {type === 'ingredient' ? (
              <div className="space-y-8">
                <div className="space-y-4">
                  <p className="text-xl opacity-80 font-bold uppercase tracking-widest">Question for Staff</p>
                ...
                <div className="space-y-4">
                  <h2 className="text-7xl font-black leading-tight chinese-font">
                    这道菜里有<br/><span className="text-yellow-300 font-black">"{content_cn}"</span>吗？
                  </h2>
                </div>
              </div>
            ) : (
              <div className="space-y-10">
                <div className="bg-white/10 p-6 rounded-[2rem] border border-white/20 relative group">
                  ...
                  <p className="text-lg font-black bg-white/10 inline-block px-4 py-1 rounded-full uppercase tracking-tighter mb-4">Question 1</p>
                  <h3 className="text-3xl font-black mb-1">Is this dish spicy?</h3>
                  <h3 className="text-5xl font-black chinese-font text-yellow-300">这个菜辣吗？</h3>
                </div>
                ...
                <div className="bg-white/10 p-6 rounded-[2rem] border border-white/20 relative group">
                  ...
                  <p className="text-lg font-black bg-white/10 inline-block px-4 py-1 rounded-full uppercase tracking-tighter mb-4">Question 2</p>
                  <h3 className="text-2xl font-black opacity-80 italic mb-1">Can you make it not spicy?</h3>
                  <h3 className="text-4xl font-black chinese-font text-yellow-300">可以做不辣吗？</h3>
                </div>
              </div>
            )}
          </>
      ...
      <div className="w-full max-w-2xl grid grid-cols-2 gap-6 pt-12 border-t border-white/20">
        ...
        >
          <span className="text-4xl font-black">YES</span>
          <span className="text-5xl font-black chinese-font">是 / 有</span>
        </button>
        ...
        >
          <span className="text-4xl font-black">NO</span>
          <span className="text-5xl font-black chinese-font">不 / 没</span>
        </button>
      </div>

      <p className="mt-8 text-[10px] font-black uppercase tracking-[0.3em] opacity-40">
