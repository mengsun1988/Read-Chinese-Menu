      ...
      <div className="p-8 md:p-12 space-y-8">
        <div className="space-y-2">
          <div className="flex items-center gap-2 mb-2">
            <span className="bg-rose-600 text-white text-[10px] font-semibold px-3 py-1 rounded-full uppercase tracking-widest">Storefront Identified</span>
          </div>
          <h2 className="text-4xl md:text-5xl font-semibold tracking-tight leading-tight">
            {store.store_name}
          </h2>
          <p className="text-rose-400 font-medium text-lg italic uppercase tracking-wider">{store.cuisine_type}</p>
        </div>
        ...
        <div className="space-y-6">
          <section>
            <h4 className="text-[10px] font-semibold text-white/40 uppercase tracking-[0.2em] mb-3">Street Guide Tip</h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <section>
              ...
              <ul className="space-y-2">
                {store.specialty_dishes.map((dish, i) => (
            ...
            <section>
              <h4 className="text-[10px] font-semibold text-white/40 uppercase tracking-[0.2em] mb-3">Price Range</h4>
              <p className="text-3xl font-semibold text-white">
                {store.average_price_range}
              </p>
            </section>
          </div>
        </div>
        ...
        <div className="pt-6">
          ...
          >
            ...
            <span className="text-sm font-medium opacity-60 group-hover:opacity-100">(Ask for Table)</span>
          </button>
        </div>
      </div>
    </div>
