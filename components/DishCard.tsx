      ...
      <div className="p-6 md:p-8 flex flex-col justify-between h-full">
        <div>
          <div className="flex justify-between items-start gap-4 mb-4">
            <h3 className="chinese-font text-4xl md:text-5xl font-black text-slate-900 leading-tight">
              {dish.dish_name_cn}
            </h3>
            {dish.price && (
              <span className="bg-slate-900 text-white font-bold px-3 py-1 rounded-xl text-xs whitespace-nowrap">
                {dish.price}
              </span>
            )}
          </div>
          
          <h4 className="text-xl font-bold text-rose-600 leading-tight mb-4 group-hover:text-rose-700">
            {dish.dish_name_en}
          </h4>
